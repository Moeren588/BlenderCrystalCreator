...
class PCG_PT_CreateCrystal(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        layout.prop(context.scene.crystal_generator, "crystal_radius")
        layout.prop(context.scene.crystal_generator, "crystal_height")
        layout.prop(context.scene.crystal_generator, "crystal_sides")
